  ...
  const handleQuickAction = (action: string) => {
    switch (action) {
      ...
      case "Schedule Meeting":
        setDrawerContent(<div>Schedule Meeting</div>);
        break;
      case "Start Call":
        setDrawerContent(<div>Start Call</div>);
        break;
      case "Create Document":
        setDrawerContent(<div>Create Document</div>);
        break;
      default:
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <QuickActionButton
                icon={<Mail />}
                text="Compose Email"
                action={() => handleQuickAction("Compose Email")}
              />
              <QuickActionButton
                icon={<Calendar />}
              ...
              <QuickActionButton
                ...
                action={() => handleQuickAction("Start Call")}
              />
              <QuickActionButton
                icon={<FileText />}
